...
function is_elicautilities_active()
{
	return is_plugin_active('elicautilities/elicautilities.php');
}
...
if (is_elicautilities_active()) {
	require_once(ABSPATH . 'wp-content/plugins/elicautilities/elicautilities.php');
	// ... include additional plugin files as needed
}